...
final class RegistryClientTests: XCTestCase {
    ...
    func testCompatibilityReportClassFieldChanges() {
        ...
        XCTAssertEqual(changes?["addedFields"] as? [String], ["test:Exam.optionalNote", "test:Exam.requiredCode"])
        ...
        XCTAssertTrue(breaking.contains("add required field test:Exam.requiredCode"), "\(breaking)")
